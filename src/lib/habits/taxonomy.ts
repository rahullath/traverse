...
const SEMANTIC_TYPE_PATTERNS: Array<{ pattern: RegExp; type: SemanticType }> = [
  ...
  // Caffeine
  {
    pattern: /energy\s*drink|monster|lucozade|red\s*bull|caffeine/i,
    type: SemanticType.ENERGY_DRINK,
  },
  ...
  // Hygiene
  {
    pattern: /oral|teeth|brush|floss/i,
    type: SemanticType.ORAL_HYGIENE_SESSIONS,
  },
  ...
  {
    pattern: /sociali[sz]e|friends|hangout|hang\s*out/i,
    type: SemanticType.SOCIALIZE,
  },
