...
export const AUTH_ERROR_CODES = {
  ...
  OAUTH_PROVIDER_ERROR: {
    ...
    userMessage:
      "There was an issue with the authentication provider. Please try again or use a different sign-in method.",
    recoverable: true,
    retryable: true,
  },
  OAUTH_ACCESS_DENIED: {
    ...
    userMessage:
      "Access was denied by the authentication provider. Please grant the necessary permissions to continue.",
    recoverable: true,
    retryable: true,
  },
...
export function mapSupabaseError(
  error: SupabaseAuthError | Error | any,
): AuthError {
