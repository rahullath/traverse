...
export default function ExitTimeDisplay({
  exitTimes,
  timeBlocks = [],
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center text-sm">
                    <svg
                      className="w-4 h-4 mr-2 text-accent-primary"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div className="flex items-center text-sm text-text-muted">
                    <span className="text-lg mr-2">
                      {getTravelIcon(exitTime.travelMethod)}
                    </span>
                    <span>
                      {exitTime.travelMethod.charAt(0).toUpperCase() +
                        exitTime.travelMethod.slice(1)}
                      {" • "}
                  ...
                  <div className="flex items-center text-sm text-text-muted">
                    ...
                    <span>
                      Total:{" "}
                      {exitTime.travelDuration + exitTime.preparationTime}{" "}
                      minutes
                    </span>
                  </div>
                </div>
      ...
      <div className="p-4 bg-blue-500/10 border-t border-blue-500/30 rounded-b-xl">
        <div className="flex items-start">
          ...
          <p className="text-sm text-blue-400">
            Exit times include travel duration and preparation time. Make sure
            to leave on time to avoid being late!
          </p>
        </div>
      </div>
    </div>
