...
export default function DegradePlanButton({
  plan,
  onDegrade,
  isDegrading = false,
}: DegradePlanButtonProps) {
  ...
  useEffect(() => {
    ...
    const checkShouldShow = () => {
      ...
      const currentBlock = blocksAfterPlanStart.find(
    ...
    return (
      <div className="bg-accent-warning/10 border border-accent-warning/30 rounded-lg p-4">
        <div className="flex items-center">
          <svg
            className="w-5 h-5 mr-2 text-accent-warning"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {!showConfirm ? (
          <div className="space-y-4">
            <div className="flex items-start">
              <svg
                className="w-6 h-6 mr-3 text-accent-warning flex-shrink-0 mt-0.5"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-text-muted mb-4">
                  You're more than 30 minutes behind. Consider degrading your
                  plan to focus on essentials: fixed commitments, routines, and
                  meals. Optional tasks will be dropped.
                </p>
                <button
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-accent-warning mb-4">
                  This action cannot be undone. Dropped tasks will be marked as
                  "skipped" and can be rescheduled later.
                </p>
