...
export function MobileLayout({
  ...
  return (
    <div className={`min-h-screen bg-slate-900 flex flex-col ${className}`}>
      ...
      {isStandalone && (
        <div
          className="h-safe-top bg-slate-900"
      ...
      {isStandalone && (
        <div
          className="h-safe-bottom bg-slate-900"
...
export function MobileNavigation({
  ...
  return (
    <nav
      className={`bg-slate-800/50 backdrop-blur-sm border-t border-slate-700 px-2 py-1 ${className}`}
    >
...
export function TouchButton({
  ...
  const baseClasses =
    "font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center";
  ...
  const variantClasses = {
    ...
    ghost:
      "text-gray-400 hover:text-white hover:bg-slate-700/50 focus:ring-slate-500",
  };
