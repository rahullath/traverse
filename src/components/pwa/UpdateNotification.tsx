...
export function UpdateNotification({
  ...
  return (
    <div
      className={`fixed bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:max-w-sm bg-slate-800 border border-slate-700 rounded-lg shadow-lg p-4 z-50 ${className}`}
    >
