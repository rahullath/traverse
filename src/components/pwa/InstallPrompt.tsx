...
export function InstallPrompt({
  ...
  return (
    <div
      className={`bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg p-4 shadow-lg ${className}`}
    >
      <div className="flex items-start justify-between">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-medium text-white">Install MessyOS</h3>
            <p className="mt-1 text-sm text-cyan-100">
              Add MessyOS to your home screen for quick access and offline
              functionality.
            </p>
          </div>
        </div>
