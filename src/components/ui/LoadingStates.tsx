...
export function LoadingState({
  ...
  const renderSpinner = () => (
    <div
      className={`animate-spin rounded-full border-2 border-gray-600 border-t-cyan-400 ${sizeClasses[size]}`}
    />
  );
  ...
  const renderPulse = () => (
    <div
      className={`bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 bg-[length:200%_100%] animate-pulse rounded ${sizeClasses[size]}`}
    />
  );
