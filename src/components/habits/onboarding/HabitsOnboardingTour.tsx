...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    content:
      "Let's take a quick tour to help you get started with building better habits.",
    target: "body",
    position: "bottom",
  },
  {
    ...
    content:
      "Here you can see your daily progress, current streaks, and overall habit statistics.",
    target: ".stats-grid",
    position: "bottom",
  },
  {
    ...
    content:
      "Click here to create a new habit. You can choose from templates or create a custom one.",
  ...
  },
  {
    ...
    content:
      "Each habit shows your current streak, weekly progress, and completion status. Click to log your progress!",
    target: ".habits-grid",
    position: "top",
  },
  {
    ...
    content:
      "On mobile devices, a quick actions widget appears here for rapid habit logging. On desktop, you can click directly on habit cards to log progress.",
  ...
  },
  {
    ...
    content:
      "Visit the analytics page to see detailed patterns, correlations, and AI-powered insights about your habits.",
  ...
  },
  {
    ...
    content:
      "Already tracking habits elsewhere? Import your data from Loop Habits or other apps.",
    target: "#import-btn",
    position: "left",
  },
  {
    ...
    content:
      "Start building better habits today. Remember, consistency beats perfection!",
    target: "body",
    position: "bottom",
  },
];
...
export const HabitsOnboardingTour: React.FC<HabitsOnboardingTourProps> = ({
  ...
  const [spotlightStyle, setSpotlightStyle] =
        ...
        >
          <div className="tour-card rounded-lg shadow-2xl p-6 max-w-sm mx-4 relative border border-border overflow-y-auto">
            ...
            {step.target !== "body" &&
              ...
              !isMobileViewport && (
                <div
                  className={`tour-arrow absolute w-3 h-3 transform rotate-45 ${getArrowPosition(step.position)}`}
                />
              )}
...
export const useHabitsOnboarding = () => {
  ...
  useEffect(() => {
    const hasCompletedOnboarding = localStorage.getItem(
      "habits-onboarding-completed",
    );
    const hasSkippedOnboarding = localStorage.getItem(
      "habits-onboarding-skipped",
    );
