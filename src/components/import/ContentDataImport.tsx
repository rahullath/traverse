      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900">
            Serializd Content Import
          </h3>
          <p className="text-sm text-gray-600">
            Import your enriched Serializd export data
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Supports enriched CSV and JSON exports from Serializd with TMDB
              data
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
            <h4 className="text-sm font-medium text-blue-900 mb-2">
              Enhanced Serializd Format Expected:
            </h4>
            <div className="text-xs text-blue-800 space-y-2">
              <p>
                <strong>Required fields:</strong> Title, Rating, Watch_Date,
                TMDB_ID
              </p>
              <p>
                <strong>Enhanced fields:</strong> Genres, Cast, Overview,
                Season_Episode, Review_Text
              </p>
              <div className="mt-2 p-2 bg-blue-100 rounded text-blue-700">
                <p>
                  <strong>✨ This importer handles:</strong>
                </p>
