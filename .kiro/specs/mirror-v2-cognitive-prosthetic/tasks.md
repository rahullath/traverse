...
- [ ] 1. Phase 1: Foundation - Remove Harmful Patterns
  - [ ] 1.1 Disable automatic triage activation in MirrorUI
  ...
  - [ ] 1.2 Create AnchorInfoCard component with neutral display
  ...
  - [ ] 1.3 Create DepartureWaypoint component
  ...
  - [ ] 1.4 Modify Timeline to display durations vs clock times
  ...
  - [ ] 1.5 Remove time-based color changes from TimeBlock
  ...
  - [ ] 1.6 Hide completion controls by default
  ...
  - [ ] 1.7 Create database migration for user preferences
  ...
  - [ ]* 1.8 Write unit tests for new components
...
- [ ] 2. Checkpoint - Verify foundation changes
  - Ensure all tests pass, ask the user if questions arise.


- [ ] 3. Phase 2: User-Initiated Support - Reality Check and Flexible Start Times
  - [ ] 3.1 Create RealityCheckService
  ...
  - [ ] 3.2 Create RealityCheckPrompt component
  ...
  - [ ] 3.3 Create ChainStartSelector component
  ...
  - [ ] 3.4 Add reality check API endpoint
  ...
  - [ ] 3.5 Integrate reality check flow in MirrorUI
...
- [ ] 4. Checkpoint - Verify user-initiated support
  - Ensure all tests pass, ask the user if questions arise.


- [ ] 5. Phase 3: Display Modes - Intent-Based Filtering
  - [ ] 5.1 Create DisplayModeService
  ...
  - [ ] 5.2 Create DisplayModeSerializer
  ...
  - [ ] 5.3 Create IntentPrompt component
  ...
  - [ ] 5.4 Create FreeActivationPrompt component
  ...
  - [ ] 5.5 Add display mode state management to MirrorUI
    - Modify `src/components/daily-plan/MirrorUI.tsx`
  ...
  - [ ] 5.6 Implement keystone-focus filtering
  ...
  - [ ] 5.7 Implement multi-anchor progressive disclosure
  ...
  - [ ] 5.8 Add display mode switcher to MirrorHeader
  ...
  - [ ] 5.9 Implement sessionStorage persistence
...
- [ ] 6. Checkpoint - Verify display modes
  - Ensure all tests pass, ask the user if questions arise.


- [ ] 7. Phase 4: Optional Analytics - Opt-In Usage Tracking
  - [ ] 7.1 Create database migration for analytics tables
    - Create migration file in `supabase/migrations/`
  ...
  - [ ] 7.2 Extend AnalyticsService with opt-in analytics methods
  ...
  - [ ] 7.3 Create TelemetrySerializer
  ...
  - [ ] 7.4 Add analytics API endpoint with opt-in check
  ...
  - [ ] 7.5 Add felt helpful feedback API endpoint
  ...
  - [ ] 7.6 Integrate opt-in analytics recording in MirrorUI
    - Modify `src/components/daily-plan/MirrorUI.tsx`
  ...
  - [ ] 7.7 Implement "Did this help today?" prompt
...
- [ ] 8. Checkpoint - Verify telemetry and analytics
  - Ensure all tests pass, ask the user if questions arise.


- [ ] 9. Phase 5: Polish & Testing - Comprehensive Validation
  - [ ] 9.1 Implement judgment language detection test
  ...
  - [ ]* 9.2 Write property test for no warning colors
  ...
  - [ ]* 9.3 Write property test for visual state constraint
  ...
  - [ ]* 9.4 Write property test for completion controls visibility
  ...
  - [ ]* 9.5 Write property test for duration vs clock time display
  ...
  - [ ]* 9.6 Write property test for keystone focus filtering
  ...
  - [ ]* 9.9 Write property test for gentle highlight timing
  ...
  - [ ]* 9.10 Write property test for recovery block visibility
...
- [ ] 11. Integration and Wiring
  - [ ] 11.1 Wire all components together in MirrorUI
  ...
  - [ ] 11.2 Update MirrorUI page to use new components
  ...
  - [ ] 11.3 Add feature flags for gradual rollout
  ...
  - [ ] 11.4 Update user preferences UI with transparent analytics opt-in
  ...
  - [ ]* 11.5 Write integration tests for complete wiring
